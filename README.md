...
Run `inkbox-codex setup` to change the choice without reconfiguring your identity, or edit `.env`; restart a running bridge with `inkbox-codex restart` to apply it. Mention mode requires a Codex version supporting `thread/inject_items`.
